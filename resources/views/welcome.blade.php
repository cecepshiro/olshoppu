...
<section class="container pt-md-3 pb-5 mb-md-3">
    ...
    <div class="row pt-4 mx-n2">
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 px-2 mb-4">
            <div class="card product-card"><span class="badge badge-danger badge-shadow">Sale</span>
                ...
                <div class="card-body py-2"><a class="product-meta d-block font-size-xs pb-1" href="#">Women’s
                        T-shirt</a>
                    <h3 class="product-title font-size-sm"><a href="{{ url('/detail') }}">Cotton Lace Blouse</a></h3>
                    <div class="d-flex justify-content-between">
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 px-2 mb-4">
            <div class="card product-card">
                ...
                <div class="card-body py-2"><a class="product-meta d-block font-size-xs pb-1" href="#">Women’s
                        Shorts</a>
                    <h3 class="product-title font-size-sm"><a href="{{ url('/detail') }}">Mom High Waist Shorts</a>
                    </h3>
                    <div class="d-flex justify-content-between">
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 px-2 mb-4">
            <div class="card product-card">
                ...
                <div class="card-body py-2"><a class="product-meta d-block font-size-xs pb-1" href="#">Men’s
                        Sunglasses</a>
                    <h3 class="product-title font-size-sm"><a href="{{ url('/detail') }}">Polarized Sunglasses</a>
                    </h3>
                    <div class="d-flex justify-content-between">
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 px-2 mb-4">
            <div class="card product-card">
                ...
                <div class="card-body py-2"><a class="product-meta d-block font-size-xs pb-1" href="#">Backpacks</a>
                    <h3 class="product-title font-size-sm"><a href="{{ url('/detail') }}">TH Jeans City Backpack</a>
                    </h3>
                    <div class="d-flex justify-content-between">
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 px-2 mb-4">
            <div class="card product-card">
                ...
                <div class="card-body py-2"><a class="product-meta d-block font-size-xs pb-1" href="#">Women's
                        Sneakers</a>
                    <h3 class="product-title font-size-sm"><a href="{{ url('/detail') }}">Leather High-Top
                            Sneakers</a></h3>
                    <div class="d-flex justify-content-between">
    ...
    <div class="text-center pt-3"><a class="btn btn-outline-accent" href="{{ url('/produk') }}">More products<i
