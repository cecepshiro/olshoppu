    ...
    <div class="row">
        <section class="col-lg-8">
            ...
            <div class="steps steps-light pt-2 pb-3 mb-5"><a class="step-item active" href="shop-cart.html">
                ...
                </a><a class="step-item active current" href="{{ url('/checkout/shipping') }}">
                    <div class="step-progress"><span class="step-count">3</span></div>
                    <div class="step-label"><i class="czi-package"></i>Shipping</div>
                </a><a class="step-item" href="{{ url('/checkout/payment') }}">
          ...
          <div class="d-none d-lg-flex pt-4">
            <div class="w-50 pr-3"><a class="btn btn-secondary btn-block" href="{{ url('/checkout/detail') }}"><i class="czi-arrow-left mt-sm-0 mr-1"></i><span class="d-none d-sm-inline">Back to Adresses</span><span class="d-inline d-sm-none">Back</span></a></div>
            <div class="w-50 pl-2"><a class="btn btn-primary btn-block" href="{{ url('/checkout/payment') }}"><span class="d-none d-sm-inline">Proceed to Payment</span><span class="d-inline d-sm-none">Next</span><i class="czi-arrow-right mt-sm-0 ml-1"></i></a></div>
          </div>
        </section>
        <!-- Sidebar-->
    ...
    <div class="row d-lg-none">
        <div class="col-lg-8">
            <div class="d-flex pt-4 mt-3">
                ...
                <div class="w-50 pl-2"><a class="btn btn-primary btn-block" href="{{ url('/checkout/payment') }}"><span
