    ...
    <div class="row">
        <section class="col-lg-8">
            ...
            <div class="steps steps-light pt-2 pb-3 mb-5"><a class="step-item active" href="shop-cart.html">
                ...
                </a><a class="step-item active current" href="{{ url('/checkout/detail') }}">
                    <div class="step-progress"><span class="step-count">2</span></div>
                    <div class="step-label"><i class="czi-user-circle"></i>Your details</div>
                </a><a class="step-item" href="{{ url('/checkout/shipping') }}">
            ...
            <div
                ...
                <div class="media align-items-center">
                    <div class="img-thumbnail rounded-circle position-relative" style="width: 6.375rem;"><span
                            ...
                            class="rounded-circle" src="{{ asset('assets/img/shop/account/avatar.jpg') }}" alt="Susan Gardner"></div>
            ...
            <div class="d-none d-lg-flex pt-4 mt-3">
                ...
                <div class="w-50 pl-2"><a class="btn btn-primary btn-block" href="{{ url('/checkout/shipping') }}"><span
