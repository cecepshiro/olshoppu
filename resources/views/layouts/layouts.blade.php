...
<body class="toolbar-enabled">
    ...
    <div class="modal-quick-view modal fade" id="quick-view" tabindex="-1">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title product-title"><a href="{{ url('/detail') }}" data-toggle="tooltip"
            ...
            <div class="navbar navbar-expand-lg navbar-light">
                <div class="container"><a class="navbar-brand d-none d-sm-block mr-3 flex-shrink-0" href="{{ url('/') }}"
                        style="min-width: 7rem;"><img width="142" src="{{ asset('assets/img/logo-dark.png') }}"
                            alt="Cartzilla" /></a><a class="navbar-brand d-sm-none mr-2" href="{{ url('/') }}"
                    ...
                    <div class="navbar-toolbar d-flex flex-shrink-0 align-items-center">
                        ...
                        <div class="navbar-tool dropdown ml-3"><a
                                class="navbar-tool-icon-box bg-secondary dropdown-toggle" href="{{ url('/cart') }}"><span
                                    class="navbar-tool-label">4</span><i class="navbar-tool-icon czi-cart"></i></a><a
                                class="navbar-tool-text" href="{{ url('/cart') }}"><small>My Cart</small>$265.00</a>
                            <!-- Cart dropdown-->
                            <div class="dropdown-menu dropdown-menu-right" style="width: 20rem;">
                                <div class="widget widget-cart px-3 pt-2 pb-3">
                                    <div style="height: 15rem;" data-simplebar data-simplebar-auto-hide="false">
                                        <div class="widget-cart-item pb-2 border-bottom">
                                            ...
                                            <div class="media align-items-center"><a class="d-block mr-2"
                                                    href="{{ url('/detail') }}"><img width="64"
                                                        src="{{ asset('assets/img/shop/cart/widget/01.jpg') }}"
                                                        alt="Product" /></a>
                                                <div class="media-body">
                                                    <h6 class="widget-product-title"><a href="{{ url('/detail') }}">Women
                                        ...
                                        <div class="widget-cart-item py-2 border-bottom">
                                            ...
                                            <div class="media align-items-center"><a class="d-block mr-2"
                                                    href="{{ url('/detail') }}"><img width="64"
                                                        ...
                                                        alt="Product" /></a>
                                                <div class="media-body">
                                                    <h6 class="widget-product-title"><a href="{{ url('/detail') }}">TH
                                            ...
                                            <div class="media align-items-center"><a class="d-block mr-2"
                                                ...
                                                <div class="media-body">
                                                    <h6 class="widget-product-title"><a
                                                            href="{{ url('/detail') }}">3-Color Sun Stash Hat</a></h6>
                                                    <div class="widget-product-meta"><span
                                        ...
                                        <div class="widget-cart-item py-2 border-bottom">
                                            ...
                                            <div class="media align-items-center"><a class="d-block mr-2"
                                                ...
                                                <div class="media-body">
                                                    <h6 class="widget-product-title"><a
                                                            href="{{ url('/detail') }}">Cotton Polo Regular Fit</a></h6>
                                                    <div class="widget-product-meta"><span
                                    ...
                                    <div class="d-flex flex-wrap justify-content-between align-items-center py-3">
                                        ...
                                        </div><a class="btn btn-outline-secondary btn-sm" href="{{ url('/cart') }}">Expand
                                            cart<i class="czi-arrow-right ml-1 mr-n1"></i></a>
                                    </div><a class="btn btn-primary btn-sm btn-block" href="{{ url('/checkout/detail') }}"><i
                                        ...
                                        <div class="mega-dropdown-column py-4 px-3">
                                            <div class="widget widget-links">
                                                ...
                                                <ul class="widget-list">
                                                    ...
                                                    <li class="widget-list-item pb-1"><a class="widget-list-link"
                                                            href="{{ url('/detail') }}">Product Page v.1</a></li>
                                                    <li class="widget-list-item pb-1"><a class="widget-list-link"
